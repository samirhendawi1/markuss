...
a different Binary Search Tree (BST) structure used for the underlying implementation.

Note: you can open this project in PyCharm or your favourite IDE if you want
to try running it.

The output should look something like the below (exact timing will vary of course):

  500        <class '__main__.BSTMultiSet'>  0.000434
 1000        <class '__main__.BSTMultiSet'>  0.000894
 2000        <class '__main__.BSTMultiSet'>  0.002043
 4000        <class '__main__.BSTMultiSet'>  0.003742
